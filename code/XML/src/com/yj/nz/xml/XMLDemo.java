...
public class XMLDemo {
    ...
    public void xStream(){
        ...
        p.setPersonid("10003");
        p.setAddress("湖南永州");
        p.setEmail("3440293452@qq.com");
        p.setFax("yjxz1的信件");
        p.setTel("15377464701");
        p.setName("yjxz03");
    ...
    public void xmlDecoder() throws FileNotFoundException {
        BufferedInputStream in = new BufferedInputStream(new FileInputStream("src/test.xml"));
    ...
    public void xmlEncoder() throws FileNotFoundException {
        BufferedOutputStream bos = new BufferedOutputStream(new FileOutputStream("src/test.xml"));
    ...
    public void dom4jParseXML() throws DocumentException {
        ...
        InputStream is = Thread.currentThread().getContextClassLoader()
                .getResourceAsStream("com/yj/nz/xml/person.xml");
